...
public class ProfileActivity extends AppCompatActivity {
    ...
    String profileName, mobileNumber, userFirebaseId;
    ...
    private void checkProfileCredentials() {
        if(!validateProfileName() | !validateProfileImage()){
            validateProfileName();
                            ...
                            if(task.isSuccessful()){
                                profileImageStorageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                    ...
                                    public void onSuccess(Uri uri) {
                                        ...
                                        userProfileChangeRequest = new UserProfileChangeRequest.Builder().setDisplayName(profileName).setPhotoUri(selectedImageUri).build();
    ...
    private void retrieveUserProfile(){
        userDatabaseReference.child(userFirebaseId).addValueEventListener(new ValueEventListener() {
            @Override
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(ProfileActivity.this,"Failed to fetch details: " + error.getMessage(),Toast.LENGTH_SHORT).show();
            }
        });
    }
}